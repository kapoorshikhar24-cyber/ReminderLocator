...
export const PRIORITIES = [
  { id: 'low', label: 'Chill', emoji: '🌱', color: '#94a3b8' },
  { id: 'medium', label: 'Important', emoji: '⭐', color: '#38bdf8' },
  { id: 'high', label: 'Urgent!', emoji: '🔥', color: '#f43f5e' },
];

export const RADIUS_PRESETS = [
  { value: 50, label: '50m (Store entrance)' },
  { value: 100, label: '100m (Close proximity)' },
  { value: 250, label: '250m (Short walk)' },
